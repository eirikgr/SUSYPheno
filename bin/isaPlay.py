...
if os.path.exists(file1): execfile(file1)
elif os.path.exists(path1+file1): execfile(path1+file1)
else:
...
if mode_casc_starttypes not in g.casc_starttypesD.keys():
