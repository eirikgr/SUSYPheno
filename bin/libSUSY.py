...
txt2pdgId_plain = dict((v,k) for k, v in pdgId2txt_plain.iteritems())
...
slha_extpar_txtslha2key = dict((v,k) for k, v in slha_extpar_key2txtslha.iteritems())
...
slha_extpar_twoch2key = dict((v,k) for k, v in slha_extpar_key2twoch.iteritems())
...
prosp_fivekey2twoch  = dict((v,k) for k, v in prosp_twoch2fivekey.iteritems())
...
prosp_twoword2twoch  = dict((v,k) for k, v in prosp_twoch2twoword.iteritems())
