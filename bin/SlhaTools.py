...
namSigned2pdg = dict( (v,k) for k,v in pdg2namSigned.iteritems() )
...
nam2pdg = dict( (v,k) for k,v in pdg2nam.iteritems() )
    ...
    def DevelopFinalstates(s, genea='', FSlist=[], particles=[], Mothers_Onelegs_existing={}, optD={}, particles2keep=[], VB=1):
        ...
        if 1: 
            ...
            for iDecay in range(len(FSlist)):   # p is BBfinalstates (of a particle)
                ...
                s.geneaLog.Add(genea=genea, S='dump', txt='DDEBUG: pname_sons=%s  len(Mothers_accumulated_ofson)=%i  keys=%s' %(pname_sons, len(Mothers_accumulated_ofson), Mothers_accumulated_ofson.keys()))
