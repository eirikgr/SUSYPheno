...
! p p-bar collisions at SqrtS=1.96 TeV (calcuated by T. Figy with VBFNLO):s
 ...
 !*****************************************************************
  ...
  use S95tables, only : inrange 
  use usefulbits, only : g2,ndat,ms,mc,mbmb,mmu,mtau,vsmall
  implicit none
  !--------------------------------------internal
  integer :: i,jj
 ...
 !************************************************************
  use usefulbits, only : ndat, &
               & allocate_hadroncolliderextras_parts,deallocate_hadroncolliderextras_parts
  use S95tables, only : inrange
