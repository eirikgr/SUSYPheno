...
!  filename(x)='CDF_D0_SM_combined_8.6fb_10606'
  ...
  S95_t1(x)%particle_x=Hneut
  S95_t1(x)%expt='TCB'
  S95_t1(x)%label='CDF Note 10806' !D0 Note 6303, final (?) Tevatron combination
  S95_t1(x)%energy=1.96D0
  S95_t1(x)%lumi=10.D0
  S95_t1(x)%SMlike=1
  S95_t1(x)%xmin=100.0D0
  ...
  S95_t1(x)%sep=5.0D0 
  S95_t1(x)%deltax=0.0D0 
  filename(x)='CDF_D0_SM_combined_10fb_10806'
...
!  filename(x)='D0_gaga_8.2fb_6177' 
  ...
  S95_t1(x)%particle_x=Hneut
  S95_t1(x)%expt='TCB'
  S95_t1(x)%label='arXiv:1107.4960 (TEVNPHWG)'!CDF Note 10510, D0 Note 6203
  S95_t1(x)%energy=1.96D0
  S95_t1(x)%lumi=8.2D0
  S95_t1(x)%xmin=100.0D0
  S95_t1(x)%xmax=150.0D0
