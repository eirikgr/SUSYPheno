...
! particle codes: (n.b. these are NOT pdg)
 ...
 subroutine HiggsBounds_info
  ...
  write(*,*)"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
  write(*,*)"~                                                        ~"
  write(*,*)"~      HiggsBounds "//adjustl(vers)//" (fortran90/2003 version)    ~"
  write(*,*)"~                                                        ~"
  ...
  write(*,*)"~          http://www.ippp.dur.ac.uk/HiggsBounds         ~"
  write(*,*)"~                                                        ~"
  write(*,*)"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
  write(*,*)
  ...
  write(*,*)"      (see arXiv:1101.0593 and ref. therein)"
  write(*,*)
...
!  call deallocate_sqcouplratio_parts(g2)
  ...
  deallocate(pr)  !allocated in subroutine fill_pr or fill_pr_select
