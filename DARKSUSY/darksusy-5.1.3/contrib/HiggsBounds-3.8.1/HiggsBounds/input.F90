...
!************************************************************      
 ...
 !************************************************************      
  use usefulbits, only : np,pdesc,inputmethod
 ...
 !************************************************************      
  use usefulbits, only : np,whichinput,inputmethod
 ...
 !********************************************************
  use usefulbits, only : np, theo, g2, partR, whichinput
  implicit none
  !--------------------------------------input
  integer :: n
  !-----------------------------------internal
