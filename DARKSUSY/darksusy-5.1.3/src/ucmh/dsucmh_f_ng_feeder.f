...
!         log10P_delta    log_10 of the amplitude of primordial density perturbations at scale k (dimensionless)
      ...
      double precision :: deltam, deltamin, dsucmh_dmin, dsucmh_betaF17, log10correction, nu, dsucmh_mvar_generalised, zstart
      ...
      dsucmh_f_ng_feeder = dsucmh_betaF17(M_3,nu) * dmfrac * (zstart + 1.d0)/(zstop + 1.d0)

      log10correction = merge(log10pt191,log10pt191timespt81,k.gt.keq)
      log10P_delta = log10P_R + log10correction

      end function dsucmh_f_ng_feeder
