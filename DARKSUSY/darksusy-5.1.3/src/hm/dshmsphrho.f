...
****************************************************************
     ...
     &  ,dshmnumrho,dshmeinastorho,dshmucmhrho
c
      if ( (radialdist.lt.rhcut) .and. (halotype .ne. 'ucmh' .or. rhcut .lt. Rh_ucmh) ) then
        rr=rhcut
      else
        rr=radialdist
      endif  
...
c profile read from disc
      ...
      elseif(halotype(1:4).eq.'UCMH') then
c UCMH r^-9/4 density profile
        dshmsphrho=dshmucmhrho(rr) 
      else
